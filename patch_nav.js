...
const startIndex = content.indexOf('<div className={`fixed inset-0 bg-black/95 z-[70]');
...
if (startIndex !== -1 && endIndex !== -1) {
    const finalContent = content.substring(0, startIndex) + newSearchModal + content.substring(endIndex);
    fs.writeFileSync('src/components/layout/Navbar.tsx', finalContent);
